    ...
    return Semantics(
      ...
      child: ElevatedButton.icon(
        ...
        onPressed: () async {
          ...
          await _speak("$name mode activated");
        },
        icon: Icon(
        icon,
        ...
        style: ElevatedButton.styleFrom(
          ...
          padding: EdgeInsets.symmetric(horizontal: 30, vertical: 18), // Large padding
      ...
      child: Row(
        ...
        children: filters.map((f) {
          return Padding(
            ...
            child: _buildFilterButton(f['name']! as String, f['icon']! as IconData),
          );
        }).toList(),
      ),
    );
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  color: const Color.fromARGB(100, 182, 182, 185),
                                  onSelected: (value) async {
                                    setState(() => _currentFilter = value);
                                    await _speak("$value mode activated");
                                  },
                                  itemBuilder: (context) => [
                                    PopupMenuItem(
                                      value: "Protanopia",
